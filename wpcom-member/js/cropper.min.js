...
cropperModal = function ( data ) {
    if(typeof data.lg === 'undefined') data.lg = 0;
    var html = '<div class="wpcom-modal member-crop-modal fade" id="crop-modal" data-backdrop="static">\n' +
        '    <div class="modal-dialog'+(data.lg?' modal-lg':'')+'">\n' +
        ...
        '                    <i class="wpcom-icon wi"><svg aria-hidden="true"><use xlink:href="#wi-camera"></use></svg></i>\n' +
        '                    <p>'+data.desc+'</p>\n' +
        '                    <div class="wpcom-btn btn-primary" onclick="jQuery(\'input[id=img-file]\').click();">'+data.btn+'</div>\n' +
        '                    <input style="display: none;" type="file" id="img-file" name="img-file" accept="image/jpeg,image/png,image/gif">\n' +
        '                </div>\n' +
        '                <div class="crop-img-wrap">\n' +
        '                    <div class="crop-close j-crop-close"><i class="wpcom-icon wi"><svg aria-hidden="true"><use xlink:href="#wi-close"></use></svg></i></div>\n' +
        '                </div>\n' +
        '            </div>\n' +
        '            <div class="modal-footer">\n' +
        '                <div class="wpcom-btn btn-primary j-crop-apply">'+data.apply+'</div>\n' +
        '                <div class="wpcom-btn" data-wpcom-dismiss="modal">'+data.cancel+'</div>\n' +
        '            </div>\n' +
        '        </div>\n' +
        '    </div>\n' +
        '</div>';
