...
<li class="comment-item">
    <div class="comment-item-meta">
        ...
        <span class="comment-item-time"><?php wpmx_icon('comments-fill'); echo esc_html($human_time);?></span> <span><?php printf(esc_html__('On %1$s %2$s %3$s', 'wpcom'), '<a target="_blank" href="'.esc_url(get_permalink($comment->comment_post_ID)).'">', esc_attr(get_the_title($comment->comment_post_ID)), '</a>' ); ?></span>
    </div>
